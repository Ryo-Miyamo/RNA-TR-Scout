...
def main() -> None:
    ...
    # Stage 15A performance lane: 11d3 already stores independently audited
    ...
    # Per-shard performance output is intentionally plain-only. The Stage 15A
    ...
    summary = [
        ...
        ("execution_adapter", "rnatr_materialize_native_v041_to_evidence_v042_runid_adapter_v0.2.1"),
        ("run_id", run_id),
        ("schema_version", "0.4.2"),
