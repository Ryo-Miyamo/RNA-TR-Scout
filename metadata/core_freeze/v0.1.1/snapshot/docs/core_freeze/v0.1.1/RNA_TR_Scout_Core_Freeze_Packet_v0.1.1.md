# RNA-TR-Scout Core Freeze Packet v0.1.1 — registered local Core Freeze

## Registration status

`LOCAL_CORE_FREEZE_V0.1.0_ACCEPTED_WITH_SCOPE`

The substantive Freeze scope below is the exact owner-approved source, preserved byte-for-byte.

- owner-approved source SHA-256: `af5c437f3e419f58c4daeaa865777751410bd006cc65ca02e40c78ed4d87aa68`
- owner-review bundle SHA-256: `63c9ed37d751295104b273ef415804ad81d307a7673e3a7cb2f69154786eb804`
- owner response: `OK` / `APPROVED_AS_WRITTEN`
- public GitHub release v0.5.0, clean install, cross-hardware and biology-ready completion remain open exactly as stated below.
- final SSOT, release-gate, golden and manifest bindings are recorded in `metadata/core_freeze/v0.1.1/`.

The historical status line inside the preserved source records its state at owner review; this registration header is the current status.

--- BEGIN EXACT OWNER-APPROVED SUBSTANTIVE SOURCE ---
...
--- END EXACT OWNER-APPROVED SUBSTANTIVE SOURCE ---
