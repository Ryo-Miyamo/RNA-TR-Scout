...
CANDIDATE_FASTQ="$RAW_ROOT/benchmarks/ENCSR307SHM/stage15c_full5312696_v1/rnatr_candidates_v0.3.1/ENCFF260PGB.full5312696.rnatr_candidate_all.fastq.gz"
...
DATA_OUTDIR="$RAW_ROOT/benchmarks/ENCSR307SHM/stage15c_full5312696_v1/rnatr_projection_v0.3.3"

PROJECTION="$OUTDIR/read_target_projection.v0.3.3.tsv.gz"
WINDOW_FASTQ="$DATA_OUTDIR/ENCFF260PGB.full5312696.rnatr_target_windows.v0.3.3.fastq.gz"
