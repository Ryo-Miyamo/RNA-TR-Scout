...
STAGE_VERSION = "rnatr_stage15a_reference_100k_v0.1.1"
...
FIX_META_ROOT = (
    PROJECT_ROOT
    / "metadata/stage15a/v0.1.1/validator_fix_bundle"
)
...
def setup_isolated_root() -> dict[str, Path]:
    ...
    scripts = {
        "11b": FROZEN_SCRIPTS
        / "11b_extract_alignment_segments_and_target_candidates.stage15a.validator_v031_fix_v0.1.1.sh",
        "11d3": FROZEN_SCRIPTS / "11d3_project_targets_to_raw_reads_secondary_seq_fixed.stage15a.sh",
        "11e": FROZEN_SCRIPTS / "11e_prepare_motif_scan_jobs.stage15a.sh",
...
def main() -> int:
    ...
    output_tar = Path.home() / "Downloads/rnatr_stage15a_reference_100k_output_v0.1.1.tar.gz"
