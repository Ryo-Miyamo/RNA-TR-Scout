...
DATA_OUTDIR="$RAW_ROOT/benchmarks/ENCSR307SHM/pilot_100k_seed20260803/rnatr_projection_v0.3.3"

PROJECTION="$OUTDIR/read_target_projection.v0.3.3.tsv.gz"
WINDOW_FASTQ="$DATA_OUTDIR/ENCFF260PGB.pilot_100k.rnatr_target_windows.v0.3.3.fastq.gz"
