...
VERSION = "rnatr_stage15c_full5312696_bam_to_final_v0.1.1"
...
SOURCE_11B = PROJECT_ROOT / "scripts/11b_extract_alignment_segments_and_target_candidates.stage15a500k_runid_v0.1.0.sh"
...
RUNNER_LOCK_CONTRACT_SHA256 = "6a658ddc31a95714a4d00604c9c66b17243774a23608a2041b7562a8e6ea0d51"
...
RESULT_ROOT = (
    PROJECT_ROOT / "results/15_stage15c_fullscale_bam_to_final" / RUN_ID / "v0.1.1"
)
QC_ROOT = (
    PROJECT_ROOT / "qc/15_stage15c_fullscale_bam_to_final" / RUN_ID / "v0.1.1"
)
PREFLIGHT_ROOT = (
    PROJECT_ROOT / "qc/15_stage15c_fullscale_runner_preflight" / RUN_ID / "v0.1.1"
)
DOC_PATH = PROJECT_ROOT / "docs/stage15c/RNA_TR_Scout_fullscale_runner_execution_contract_v0.1.1.md"
SCRIPT_INSTALL = PROJECT_ROOT / "scripts/rnatr_stage15c_run_full5312696_bam_to_final_v0.1.1.py"
DOWNLOADS = Path.home() / "Downloads"
PREFLIGHT_BUNDLE = DOWNLOADS / "rnatr_stage15c_fullscale_runner_preflight_v0.1.1.tar.gz"
SUCCESS_BUNDLE = DOWNLOADS / "rnatr_stage15c_full_empirical_run_v0.1.1.tar.gz"
FAILURE_BUNDLE = DOWNLOADS / "rnatr_stage15c_full_empirical_run_v0.1.1_failure.tar.gz"
...
def write_execution_contract(model: ResourceModel) -> None:
    ...
    text = f"""# RNA-TR-Scout Stage 15C full-scale execution contract v0.1.0

Contract version date: 2026-08-09
...
def preflight() -> int:
    ...
    make_bundle(PREFLIGHT_BUNDLE, [PREFLIGHT_ROOT, DOC_PATH, SCRIPT_INSTALL], "rnatr_stage15c_fullscale_runner_preflight_v0.1.1")
    ...
    print("execute_authorized\tfalse")
...
def execute(confirm_run_id: str) -> int:
    ...
    make_bundle(SUCCESS_BUNDLE, selected_roots, "rnatr_stage15c_full_empirical_run_v0.1.1")
...
def failure_bundle(exc: BaseException) -> None:
    try:
        ...
        make_bundle(FAILURE_BUNDLE, [QC_ROOT, DOC_PATH, SCRIPT_INSTALL], "rnatr_stage15c_full_empirical_run_failure_v0.1.1")
