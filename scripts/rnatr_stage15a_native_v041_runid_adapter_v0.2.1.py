...
def main():
    ...
    ap.add_argument("--window-fastq",type=Path,required=True)
    ...
    summary=[
        ("stage_version","rnatr_stage15a_native_v041_runid_adapter_v0.2.1"),
        ("scientific_execution_base","rnatr_stage15a_native_v041_no_legacy_audit_v0.2.0"),
        ("run_id",run),
        ("window_fastq",windows_p),
    ...
    print("===== RNA-TR-SCOUT GENERAL CALLER RUN-ID ADAPTER =====")
