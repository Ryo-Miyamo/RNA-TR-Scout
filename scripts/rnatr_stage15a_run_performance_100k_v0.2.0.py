...
STAGE_VERSION = "rnatr_stage15a_sharded_bam_to_final_performance_v0.2.0"
PROJECT_ROOT = Path("/mnt/intelssd/rnatr_project")
RUN_ID = "ENCSR307SHM_pilot100k_mm2splice_v1"
SAMPLE_ID = "ENCSR307SHM"
RESULT_ROOT = PROJECT_ROOT / "results/15_stage15a_bam_to_final" / RUN_ID / "v0.2.0_performance"
QC_ROOT = PROJECT_ROOT / "qc/15_stage15a_bam_to_final" / RUN_ID / "v0.2.0_performance"
...
def main() -> int:
    ...
    if RESULT_ROOT.exists() or QC_ROOT.exists():
        raise RuntimeError(
            f"v0.2.0 performance root already exists; preserve it and review before rerun: {RESULT_ROOT}"
        )
