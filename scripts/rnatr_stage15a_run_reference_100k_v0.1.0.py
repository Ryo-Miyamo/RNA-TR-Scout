...
STAGE_VERSION = "rnatr_stage15a_reference_100k_v0.1.0"
...
def setup_isolated_root() -> dict[str, Path]:
    ...
    scripts = {
        "11b": FROZEN_SCRIPTS / "11b_extract_alignment_segments_and_target_candidates.stage15a.sh",
...
def main() -> int:
    ...
    output_tar = Path.home() / "Downloads/rnatr_stage15a_reference_100k_output_v0.1.0.tar.gz"
