...
SOURCE_11B = Path('/mnt/intelssd/rnatr_project/scripts/stage15c/full5312696_runtime_bound_v0.1.6/11b_extract_alignment_segments_and_target_candidates.stage15c_full5312696_runtime_bound_v0.1.6.sh')
SOURCE_11D3 = Path('/mnt/intelssd/rnatr_project/scripts/stage15c/full5312696_runtime_bound_v0.1.6/11d3_project_targets_to_raw_reads.stage15c_full5312696_runtime_bound_v0.1.6.sh')
SOURCE_11E = Path('/mnt/intelssd/rnatr_project/scripts/stage15c/full5312696_runtime_bound_v0.1.6/11e_prepare_motif_scan_jobs.stage15c_full5312696_runtime_bound_v0.1.6.sh')
SOURCE_SHA = {
    SOURCE_11B: 'bc7523c081434ba7e545a3191aad4e7cb8c4e9d4c1ca771b3658399875a7fcd8',
    SOURCE_11D3: 'aa91b0ec33caee71c223ea6ac161de2b2ceb0095ae33a404f85bba51a81553c3',
...
PRIOR_V015_RUNNER = Path('/mnt/intelssd/rnatr_project/scripts/rnatr_stage15c_run_full5312696_bam_to_final_v0.1.5.py')
PRIOR_V015_RUNNER_SHA256 = 'ef04486e6bac8f0a3a4949267d7260d30fc02bf60ec276b4276bb39c090a9964'
PRIOR_V015_BUILD_QC = Path('/mnt/intelssd/rnatr_project/qc/15_stage15c_runtime_bound_runner_build/ENCSR307SHM_stage15c_full5312696_seed20260809_mm2splice_v1/v0.1.5/stage15c_runtime_bound_runner_build.qc.tsv')
PRIOR_V015_BUILD_QC_SHA256 = '3843f59627e31711670b485ddd93fc3535d435ee75d4508c11ed67992a5e89a5'
PRIOR_V015_AMENDMENT = Path('/mnt/intelssd/rnatr_project/metadata/stage15c/runtime_script_binding_amendment_v0.1.5/rnatr_stage15c_runtime_script_binding_amendment_v0.1.5.json')
PRIOR_V015_AMENDMENT_SHA256 = '61576df920008f0e96b73e3246dae7a53404c68c380c74f00491aa459983af82'
BOUND_SOURCE_ROOT = Path('/mnt/intelssd/rnatr_project/scripts/stage15c/full5312696_runtime_bound_v0.1.6')
BOUND_RUNTIME_SOURCE_PATHS = {role: Path(path) for role, path in {'11b': '/mnt/intelssd/rnatr_project/scripts/stage15c/full5312696_runtime_bound_v0.1.6/11b_extract_alignment_segments_and_target_candidates.stage15c_full5312696_runtime_bound_v0.1.6.sh', '11d3': '/mnt/intelssd/rnatr_project/scripts/stage15c/full5312696_runtime_bound_v0.1.6/11d3_project_targets_to_raw_reads.stage15c_full5312696_runtime_bound_v0.1.6.sh', '11e': '/mnt/intelssd/rnatr_project/scripts/stage15c/full5312696_runtime_bound_v0.1.6/11e_prepare_motif_scan_jobs.stage15c_full5312696_runtime_bound_v0.1.6.sh'}.items()}
BOUND_RUNTIME_SOURCE_SHA256 = {'11b': 'bc7523c081434ba7e545a3191aad4e7cb8c4e9d4c1ca771b3658399875a7fcd8', '11d3': 'aa91b0ec33caee71c223ea6ac161de2b2ceb0095ae33a404f85bba51a81553c3', '11e': '23c02846128b4cddefdba6879bbd731b30d552d70e9070b5d9122aebf7e5c0e2'}
EXPECTED_GENERATED_NORMALIZED_SHA256 = {'11b': '64bf197ac1ed9903a1dd1f42aed9e6bc6ae7e50bcd699491d2ede53ea275679b', '11d3': '446fb155d1bc8793d805dea121bf6f52f2b5efedc2f95cf11e62f493bd29e9ec', '11e': 'b01d66e3c05cb8f1dbd1e5b9fc57f914affd8a4b87aed4abd3b3dbde7b17c398'}
OBSOLETE_TEMPLATE_RUN_ID = 'ENCSR307SHM_stage15a500k_seed20260809_mm2splice_v1'
OBSOLETE_RUNTIME_PATH_TOKENS = ('stage15a_500k_seed20260809_v1', 'ENCFF260PGB.stage15a_500k.rnatr_candidate_all.fastq.gz', 'ENCFF260PGB.stage15a_500k.rnatr_target_windows.v0.3.3.fastq.gz')
RUNTIME_SCRIPT_BINDING_AMENDMENT = Path('/mnt/intelssd/rnatr_project/metadata/stage15c/runtime_path_binding_amendment_v0.1.6/rnatr_stage15c_runtime_path_binding_amendment_v0.1.6.json')
RUNTIME_SCRIPT_BINDING_AMENDMENT_SHA256 = 'c972777c13834ca9c16bc7d4aaecbebb20d46d3518d266a851f17a7b4751d97a'
EXPECTED_RUNTIME_PATH_CHECKS_PER_SHARD = 23
EXPECTED_FULL_RUNTIME_PATH_CHECKS = 3312
...
def verify_runtime_script_binding_amendment() -> dict[str, Any]:
    ...
    for key, expected in {
        "schema": 'rnatr.runtime_path_binding_amendment.v1',
...
QC_ROOT = (
    PROJECT_ROOT / "qc/15_stage15c_fullscale_bam_to_final" / RUN_ID / "v0.1.6"
)
PREFLIGHT_ROOT = (
    PROJECT_ROOT / "qc/15_stage15c_fullscale_runner_preflight" / RUN_ID / "v0.1.6"
)
...
def write_execution_contract(model: ResourceModel) -> None:
    ...
    text = f"""# RNA-TR-Scout Stage 15C full-scale execution contract v0.1.6

Contract version date: 2026-08-10

## Runtime-generated script ID and path binding amendments

- v0.1.6 runtime-path amendment SHA-256: `c972777c13834ca9c16bc7d4aaecbebb20d46d3518d266a851f17a7b4751d97a`
- Candidate benchmark root: `stage15c_full5312696_v1`
- Candidate FASTQ filename: `ENCFF260PGB.full5312696.rnatr_candidate_all.fastq.gz`
- Window FASTQ filename: `ENCFF260PGB.full5312696.rnatr_target_windows.v0.3.3.fastq.gz`
...
- The failed v0.1.4 partition is not reused; v0.1.6 performs a fresh partition inside the formal timer.
...
def preflight() -> int:
    ...
    fixture_path_checks = sum(int(row["path_binding_checks_passed"]) for row in fixture_rows)
    ...
    make_bundle(PREFLIGHT_BUNDLE, [PREFLIGHT_ROOT, DOC_PATH, SCRIPT_INSTALL, EXECUTION_UNLOCK_CONTRACT, RUNTIME_SCRIPT_BINDING_AMENDMENT, BOUND_SOURCE_ROOT], "rnatr_stage15c_fullscale_runner_preflight_v0.1.6")
...
def verify_preflight_for_execute(current_script: Path) -> dict[str, str]:
    ...
    required = {
        ...
        "runtime_script_path_binding_fixture_status": "PASS",
        "runtime_script_path_binding_fixture_checks": "23",
        "runtime_script_path_binding_expected_per_shard_checks": "23",
        "runtime_script_path_binding_expected_full_checks": "3312",
        "runtime_generated_normalized_sha_fixture_status": "PASS",
        "v014_failed_partition_reused": "false",
        "v015_preflight_executed": "false",
        "v015_full_execution_started": "false",
...
def execute(confirm_run_id: str) -> int:
    ...
    if not FULL_EXECUTION_AUTHORIZED:
        raise RunnerError("FULL_EXECUTION_NOT_AUTHORIZED_BY_V0.1.6_RUNTIME_PATH_BINDING_AMENDMENT")
    ...
    runtime_path_checks = sum(int(row["path_binding_checks_passed"]) for row in runtime_script_rows)
    ...
    make_bundle(SUCCESS_BUNDLE, selected_roots, "rnatr_stage15c_full_empirical_run_v0.1.6")
...
def failure_bundle(exc: BaseException) -> None:
    try:
        ...
        make_bundle(FAILURE_BUNDLE, [QC_ROOT, DOC_PATH, SCRIPT_INSTALL, EXECUTION_UNLOCK_CONTRACT, RUNTIME_SCRIPT_BINDING_AMENDMENT, BOUND_SOURCE_ROOT], "rnatr_stage15c_full_empirical_run_failure_v0.1.6")
