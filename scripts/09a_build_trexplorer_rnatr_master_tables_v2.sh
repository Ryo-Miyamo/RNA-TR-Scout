...
TMPDIR_LOCAL="$PROJECT_ROOT/tmp/09a_build_trexplorer_master_v2"
...
LOCUS_HELPER="$TMPDIR_LOCAL/build_locus_master.py"
REGION_HELPER="$TMPDIR_LOCAL/build_analysis_regions.py"
